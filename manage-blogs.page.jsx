            ...
            <InPageNavigation routes={["Published Blogs", "Drafts"]} defaultActiveIndex={ activeTab!='draft' ? 0 : 1}>
                {
                    ...
                    <> 
                        ...
                        <LoadMoreDataBtn state={blogs} fetchDataFun={getBlogs} additionalParams={{ draft:false, deletedDocCount: blogs.deletedDocCount }} />
                    </>
                    : 
                ...
                }
                {
                    ...
                    <> 
                        ...
                        <LoadMoreDataBtn state={drafts} fetchDataFun={getBlogs} additionalParams={{ draft:true, deletedDocCount: drafts.deletedDocCount }} />
                    </>
                    : 
